...
```bash
wget https://github.com/gofast-live/gofast-cli/releases/download/v0.13.0/gofast-linux-amd64 -O /usr/local/bin/gofast
...
```bash
wget https://github.com/gofast-live/gofast-cli/releases/download/v0.13.0/gofast-darwin-amd64 -O /usr/local/bin/gofast
chmod +x /usr/local/bin/gofast
```
...
```bash
curl -L -o gofast.exe https://github.com/gofast-live/gofast-cli/releases/download/v0.13.0/gofast-windows-amd64.exe
