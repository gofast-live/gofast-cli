...
```sh
wget https://github.com/gofast-live/gofast-cli/releases/download/v0.5.0/gofast-linux-amd64 -O /usr/local/bin/gofast
...
```sh
wget https://github.com/gofast-live/gofast-cli/releases/download/v0.5.0/gofast-darwin-amd64 -O /usr/local/bin/gofast
chmod +x /usr/local/bin/gofast
```

#### Windows
```sh
curl -L -o gofast.exe https://github.com/gofast-live/gofast-cli/releases/download/v0.5.0/gofast-windows-amd64.exe
