...
func (m model) View() string {
	...
	if m.step == 0 {
		...
		b.WriteRune('\n')
		b.WriteRune('\n')
		b.WriteString("Check the " + focusedStyle.Render("README.md") + " file for more information on how to run the project.")
		b.WriteRune('\n')
		b.WriteRune('\n')
		b.WriteString(successStyle.Render("Have fun building your project!"))
		b.WriteRune('\n')
