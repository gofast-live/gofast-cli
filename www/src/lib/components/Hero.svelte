...
<section
    class="min-h-screen flex flex-col items-center justify-center relative p-6"
>
    <!-- Top Nav -->
    <nav
        class="absolute top-0 left-0 w-full p-6 flex justify-between items-center text-sm text-muted"
    >
    ...
    <div class="flex flex-col items-center text-center max-w-3xl w-full">
        <!-- Logo -->
        <div
            class="mb-8 w-24 h-24 bg-surface rounded-2xl flex items-center justify-center border border-border shadow-2xl p-4"
        >
            <img
                src="/logo.svg"
                alt="GoFast Logo"
        ...
        <h1
            class="text-4xl md:text-6xl font-bold tracking-tight mb-4 text-white"
        >
            ...
            >
                ...
                <div class="flex justify-between items-center relative z-10">
                    <span class="text-white">
                        <span class="text-primary mr-2">$</span>gof init
                        myproject
                    </span>
                    <span
                        class="flex items-center justify-center w-10 h-10 rounded-full bg-primary/10 text-primary group-hover:bg-primary group-hover:text-white transition-all"
                    >
                        <Play
                            size={20}
                            fill="currentColor"
